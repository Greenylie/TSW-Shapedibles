...
<%@ page contentType="text/html; charset=UTF-8" import="java.util.*, model.bean.*, model.datasource.*, javax.sql.DataSource"%>
...
<form action="${pageContext.request.contextPath}/Checkout" id="addressForm" method="post" >
	...
	<select name="address" id="address">
	 ...
	 %>
	 <option value="<%=bean.getId()%>"><%=bean.selectString()%></option>
	 <%} %>
	</select> <br>
